...
class MonMiniGridEnv(minigrid.MiniGridEnv):
  ...
  def add_custom_reward(self, custom_rewards):
    self._custom_rewards = custom_rewards
  ...
  def _build_raw_grid(self):
    ...
    if self._goal_default_pos is not None and self._goal_default_pos != 3.14:
  ...
  def _gen_grid(self, width, height):
    ...
    if 'g' not in self._raw_grid and self._goal_default_pos == 3.14:
